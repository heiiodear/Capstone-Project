...
function ProjectName() {
  return (
    <>
      <body className='min-h-screen bg-indigo-950 flex justify-center items-center'>
        <div className='flex flex-col items-center gap-3 md:gap-4 px-4 text-center'>
            ...
            <button className='text-base md:text-lg font-semibold text-indigo-950 px-6 sm:px-8 md:px-10 py-2 bg-white rounded-full
