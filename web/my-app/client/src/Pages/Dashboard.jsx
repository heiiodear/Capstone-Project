    ...
    return (
        <div className="min-h-screen bg-white pt-16">
            ...
            <div className="container mx-auto py-6 px-4">
                <h1 className="text-3xl font-bold text-indigo-900 mb-6 cursor-default">Dashboard</h1>

                <div className="flex justify-between items-center mb-4">
                    <h2 className="text-xl font-semibold text-indigo-900 cursor-default">Alert Status</h2>
                    <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4">
                    <div className="border-2 border-gray-200 rounded-lg p-4 shadow-md">
                        <p className="text-sm text-gray-500 cursor-default">Active Alerts</p>
                        <div className="flex items-center mt-2">
                            <div className="w-3 h-3 bg-red-600 rounded-full mr-2" />
                            <p className="text-2xl font-bold text-indigo-900 cursor-default">{activeAlerts}</p>
                        </div>
                    </div>

                    <div className="border-2 border-gray-200 rounded-lg p-4 shadow-md">
                        <p className="text-sm text-gray-500 cursor-default">Resolved</p>
                        <div className="flex items-center mt-2">
                            <div className="w-3 h-3 bg-indigo-500 rounded-full mr-2" />
                            <p className="text-2xl font-bold text-indigo-900 cursor-default">{resolvedAlerts}</p>
                        </div>
                    </div>
                </div>
                ...
                {/* Room Status Section */}
                <div className="mt-10">
                    <h2 className="text-xl font-semibold text-indigo-900 mb-4 cursor-default">Room Status</h2>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4">
                        {Object.entries(roomStatuses).map(([room, status]) => {
                            ...
                            return (
                                <div key={room} className="flex justify-between items-center border-2 border-gray-200 rounded-lg p-4 py-6 shadow-md">
                                    <div>
                                        <h3 className="font-semibold text-lg cursor-default">{room}</h3>
                                        <p className="text-sm text-gray-600 cursor-default">{statusDetails.text}</p>
                                    </div>
