    ...
    return (
        <div className="fixed inset-0 bg-black/50 flex justify-center items-center z-50">
            <div className="bg-white rounded-lg shadow-lg max-w-2xl w-full p-6 relative">
                ...
                <p className="text-gray-700 text-s mb-2"><b className="font-semibold">Time: </b>{formatDate(alert.timestamp)}</p>
                <p className="text-gray-700 text-s mb-5">{alert.description || alert.note || "No description available."}</p>

                {alert.image_url && (
                <img
                    src={alert.image_url} //video_url
                    alt="Monitoring Clip"
